...
#seq_numbers = ["00"] #technically this would be correct for shrec, but using the kitti numberings avoids breaking some stuff in report generation, and better matches the "runs" in the thesis
skip_every = 1
