        ...
        for i in range(line_segments_unit.shape[0]):
            ...
            if axis is not None:
                ...
                cylinder_segment = cylinder_segment.rotate(
                    R=o3d.geometry.get_rotation_matrix_from_axis_angle(axis_a) )#, center=True) #TODO API changed? doesn't like center=true, seems to want either a vector or nothing at all
                # cylinder_segment = cylinder_segment.rotate(
